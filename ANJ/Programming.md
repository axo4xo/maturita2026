...
- **My Favorite Program (Talk about your setup):** * Pick your IDE (e.g., Visual Studio Code, IntelliJ IDEA, or WebStorm).
    ...
    - Tell them _why_ it's your favorite: _"My favourite program is my IDE because I use it every day to build fullstack web applications. I love it because I can write my frontend in Next.js, test my Spring Boot backend, and manage my Git repositories all in one window without leaving the program."_
