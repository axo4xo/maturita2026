...
Start with the physical stuff (ergonomics and electricity) because it's quick and easy. Then transition to the software side: _"However, protecting the hardware is not enough. We also have to protect the data."_ Then just list the types of malware. Since you build software and configure Linux servers, just talk about how you secure them (e.g., using firewalls, closing ports, keeping dependencies updated). That alone sounds like a professional presentation, not just a high school exam.
